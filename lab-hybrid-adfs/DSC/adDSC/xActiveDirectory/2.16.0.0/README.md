 ...
 * The Active Directory domain's fully-qualified domain name must be specified, i.e. centoso.tk.
...
$ConfigData = @{
    AllNodes = @(
        @{
            ...
            Role = "Primary DC"
            DomainName = "dsc-test.centoso.tk"
...
$ConfigData = @{
    ...
    AllNodes = @(
        ...
        @{
            ...
            ParentDomainName = "dsc-test.centoso.tk"
            CertificateFile = "C:\publicKeys\targetNode.cer"
            Thumbprint = "AC23EA3A9E291A75757A556D0B71CBBF8C4F6FD8"
            RetryCount = 50
            RetryIntervalSec = 30
...
Sample_xADDomainTrust_OneWayTrust -configurationdata $config `
                                  -SourceDomain safeharbor.centoso.tk `
                                  -TargetDomain corporate.centoso.tk `
...
Example_xADDomainDefaultPasswordPolicy -DomainName 'centoso.tk' -ComplexityEnabled $true -MinPasswordLength 8
